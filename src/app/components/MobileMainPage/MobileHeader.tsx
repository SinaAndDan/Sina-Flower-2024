...
const MobileHeader: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* 
      <figure className="max-w-lg bg-current">
        <Image
      ...
      <div className="w-2/3 m-auto bg-white border border-gray-200 rounded-lg shadow  mt-2 h-auto">
        <Image
          className="rounded-t-lg m-auto h-64 w-64"
          src={GreenFlower}
          alt=""
        />
      </div>
