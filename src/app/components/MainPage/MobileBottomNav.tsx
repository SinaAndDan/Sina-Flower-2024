...
const MobileBottomNav: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-[60px] bg-gradient-to-r from-[#0f4a1e] via-[#1f7853] to-[#1e8e63] rounded-full z-50 fixed bottom-0 flex justify-between items-center px-7 md:hidden">
      {menuItems.map((item) => {
